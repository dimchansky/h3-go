...
func TestGeoToFaceIJK(t *testing.T) {
    tests := []struct{ lat, lng float64; res int; expected FaceIJK }{
        {37.7749, -122.4194, 0, FaceIJK{7, coordijk.CoordIJK{0,0,1}}},
        {51.5074, -0.1278,   0, FaceIJK{3, coordijk.CoordIJK{1,0,0}}},
        {0.0,     0.0,       0, FaceIJK{9, coordijk.CoordIJK{0,0,2}}},
        {37.7749, -122.4194, 1, FaceIJK{7, coordijk.CoordIJK{0,1,3}}},
        {89.0,    0.0,       0, FaceIJK{1, coordijk.CoordIJK{1,0,0}}},
    }
