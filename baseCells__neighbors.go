...
// in each of the 7 IJK directions (CENTER, J, quadJK, K, IK, I, quadIJ).
// invalidBaseCell indicates no neighbor in that direction.
// Ported from H3 C: baseCells.c::baseCellNeighbors.
var baseCellNeighbors = [numBaseCells][7]int32{
