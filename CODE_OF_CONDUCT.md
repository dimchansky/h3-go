...
5. **Violating confidentiality.** Sharing or acting on someone's personal
...
report a possible violation, email the maintainer at
**dimchansky@gmail.com** with a description of the incident; reports are
...
as possible while prioritizing safety and confidentiality. In order to
honor these values, enforcement actions are carried out in private with the
...
2. Temporarily Limited Activities
   ...
   2. Consequence: A private, written warning with a time-limited cooldown
      ...
      cooldown period may be limited to particular communication channels
...
ability of Community Managers to use their discretion and judgment, in
keeping with the best interests of our community.

## Scope

This Code of Conduct applies within all community spaces, and also applies
when an individual is officially representing the community in public or
other spaces. Examples of representing our community include using an
