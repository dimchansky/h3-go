...
// Inline C helper to call _faceIjkPentToCellBoundary
static inline void face_ijk_pent_to_cell_boundary_c(const FaceIJK* h, int res, int start, int length, CellBoundary* g) {
    _faceIjkPentToCellBoundary(h, res, start, length, g);
}
*/
import "C"
